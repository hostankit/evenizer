    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('meetings').where('eventid', isEqualTo: eventdata).snapshots(),
          builder: (context, snapshot) {
            ...
            var edata = snapshot.data!.docs[0];
            print(edata.reference.id);
            ...
            return ListView(
              ...
              children: [
                ...
                SizedBox(height: 10),
                // Text(
                //   'Date: '+DateFormat('dd MMM, yyyy').format(edata['date']).toString(),
                //   style: TextStyle(
                //       fontSize: 16,
                //       fontWeight: FontWeight.w500,
                //       color: Colors.black87
